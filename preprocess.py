...
class Datasets():
    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            ...
            data_gen = tf.keras.preprocessing.image.ImageDataGenerator(rotation_range=15, width_shift_range=25.0,
            height_shift_range=25.0, channel_shift_range=1.0, preprocessing_function=self.preprocess_fn)
